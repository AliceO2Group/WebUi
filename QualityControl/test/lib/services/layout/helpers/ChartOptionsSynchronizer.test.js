  ...
  suite('ChartOptionsSynchronizer Test Suite', () => {
    ...
    suite('sync() method', () => {
      ...
      test('should create new chart options when none exist', async () => {
        ...
        mockChartOptionRepository.createChartOption = (data) => {
      ...
      test('should delete chart options that are no longer present', async () => {
        ...
        mockChartOptionRepository.deleteChartOption = (data) => {
      ...
      test('should not create or delete when options are already synchronized', async () => {
        ...
        mockChartOptionRepository.deleteChartOption = () => {
          deleteCalled = true;
        };

        mockChartOptionRepository.createChartOption = () => {
          createCalled = true;
        };
      ...
      test('should throw error when createChartOption fails', async () => {
        const chart = { id: 1, options: ['option1'] };
        ...
        mockChartOptionRepository.createChartOption = () => Promise.reject(error);
