...
function listLayouts(filter = {}) {
  ...
  return promiseResolveWithLatency(layouts.filter((layout) => filter.owner_id === undefined || layout.owner_id === filter.owner_id));
}
...
const _readObjectData = readObjectData;
export { _readObjectData as readObjectData };

const _listObjects = listObjects;
export { _listObjects as listObjects };

export const listOnlineObjects = listObjects;

const _isOnlineModeConnectionAlive = isOnlineModeConnectionAlive;
export { _isOnlineModeConnectionAlive as isOnlineModeConnectionAlive };
...
export const layoutService = new LayoutController(dataConnector);

export const objectController = new ObjectController(ccdb);
