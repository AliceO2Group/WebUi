...
// /usr/src/app/lib/database/migrations/20250313145640-create-tabs-table.mjs
'use strict';

/** @type {import('sequelize-cli').Migration} */

/**
 * Migration script to create the 'tabs' table.
...
/**
 * Migration script to drop the 'tabs' table.
 * @param {object} queryInterface - The interface for database operations.
