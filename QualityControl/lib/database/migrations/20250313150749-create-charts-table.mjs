...
// /usr/src/app/lib/database/migrations/20250313150749-create-charts-table.mjs
'use strict';

/** @type {import('sequelize-cli').Migration} */

/**
 * Migration script to create the 'charts' table.
...
/**
 * Migration script to drop the 'charts' table.
 * @param {object} queryInterface - The interface for database operations.
