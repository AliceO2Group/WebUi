...
// /usr/src/app/lib/database/migrations/20250313142147-create-users-table.mjs
'use strict';

/** @type {import('sequelize-cli').Migration} */

/**
 * Migration script to create the 'layouts' table.
...
/**
 * Migration script to drop the 'layouts' table.
 * @param {object} queryInterface - The interface for database operations.
