 ...
 */
export class SendAllTokensCommand implements Command {
  readonly event = DuplexMessageEvent.MESSAGE_EVENT_SEND_ALL_TOKENS;
  constructor(public payload: TokenListPayload) {}
}
