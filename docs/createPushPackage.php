...
$certificate_path = "<.p12 certificate path>";     // Change this to the path where your certificate is located
$certificate_password = "<certificate password>"; // Change this to the certificate's import password
