...
describe('Logging: InfoLoggerMessage', () => {
  describe('_removeNewLinesAndTabs: ', () => {
    it('should successfully parse Error into one line string message', () => {
      strictEqual(InfoLoggerMessage._removeNewLinesAndTabs(new Error('Error in Error')),
        'Error: Error in Error', 'Parsed message from Error is incorrect');
    });

    it('should successfully parse Object into one line string message', () => {
      // eslint-disable-next-line require-jsdoc
      class T {constructor() {this.message = 'Test Class Parse';} }
      strictEqual(InfoLoggerMessage._removeNewLinesAndTabs(new T()),
        '{"message":"Test Class Parse"}', 'Parsed message from class T is incorrect');
      strictEqual(InfoLoggerMessage._removeNewLinesAndTabs({error: 'Error in JSON'}),
        '{"error":"Error in JSON"}', 'Parsed message from JSON is incorrect');
    });
    ...
    it('should successfully parse multi-line string into one line string message', () => {
      ...
      strictEqual(InfoLoggerMessage._removeNewLinesAndTabs(multiLineString),
