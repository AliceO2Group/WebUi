 ...
 *
 * @param {string} - name of the detector
...
export const detectorComponent =
  (detector, isLocked, isCurrentOwner, isSelected, isActive, lockCallback, selectionCallback) => {
    return h('.text-center.m1.f3.shadow-level1.flex-row', {
      style: 'width: 5em;'
    }, [
      h('.w-40.p1', detectorLock(detector, isLocked, isCurrentOwner, lockCallback)),
      h('.w-60.p1', detectorSelection(detector, isSelected, isLocked && isCurrentOwner, isActive, selectionCallback))
    ])
  };
